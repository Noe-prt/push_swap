...
void push_numbers_to_b(t_stack *stack_a, t_stack *stack_b)
{
    ...
    {
        if (get_push_cost(stack_a->array[i], get_target_b_value(stack_a->array[i], stack_b), stack_a, stack_b) < lower_push_cost)
        {
            lower_push_cost = get_push_cost(stack_a->array[i], get_target_b_value(stack_a->array[i], stack_b), stack_a, stack_b);
            value = stack_a->array[i];
